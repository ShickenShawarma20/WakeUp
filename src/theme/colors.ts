...
const day: CircadianPalette = {
  ...
  accentPrimaryDim:  '#0ea5e9',
  accentSecondary:   '#7dd3fc',
  tertiary:          '#bae6fd',
  tertiaryContainer: 'rgba(56, 189, 248, 0.2)',
  ...
  outlineVariant:   'rgba(186, 230, 253, 0.15)',

  toggleActive:   '#38bdf8',
  toggleInactive: 'rgba(14, 165, 233, 0.3)',
...
const noon: CircadianPalette = {
  ...
  accentPrimaryDim:  '#f59e0b',
  accentSecondary:   '#fde047',
  tertiary:          '#fef08a',
  tertiaryContainer: 'rgba(251, 191, 36, 0.2)',
  ...
  outlineVariant:   'rgba(253, 230, 138, 0.15)',

  toggleActive:   '#fbbf24',
  toggleInactive: 'rgba(120, 53, 15, 0.5)',
